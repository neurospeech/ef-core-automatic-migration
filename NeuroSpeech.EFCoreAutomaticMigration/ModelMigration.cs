...
namespace NeuroSpeech.EFCoreAutomaticMigration
{
    public class ModelMigration : ModelMigrationBase
    {
        ...
        internal protected override string LoadTableColumns()
        {
        ...
        protected override bool ModelExists(string tableName, string model)
        {
            ...
            Run(TemplateQuery.New($"INSERT INTO {tableNameLiteral} (DateApplied, CurrentModel) VALUES ({DateTime.UtcNow}, {model})"));
