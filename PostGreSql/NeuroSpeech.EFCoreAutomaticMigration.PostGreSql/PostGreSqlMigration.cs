...
namespace NeuroSpeech.EFCoreAutomaticMigration.PostGreSql
{
    public class PostGreSqlMigration : ModelMigrationBase
    {
        ...
        protected override string LoadTableColumns()
        {
        ...
        {
            return NeuroSpeech.EFCoreAutomaticMigration.PostGreSql.Scripts.SqlServerGetIndexes;
        }
